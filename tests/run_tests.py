...
#     print("Running check_missing_values...")
#     # Manually enter the exact errors we expect for a missing value in each field
#     expected_errors = ["file: 'PH395_UP_FB_20260905_04.tfif' not in assets/", "file: 'PH395_UP_FB_20260905_04.tif' exists in assets but not in csv", "identifier: PH395_UP_FB_20260905_04 doesn't match 'PH395_UP_FB_20260905_04.tfif"]
#     filepaths=""
